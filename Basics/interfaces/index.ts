...
// ps: 注意
// 4.1 一旦定义了任意属性，那么确定属性和可选属性的类型都必须是它的类型的子集
// interface Person41 {
//   name: string;
//   age?: number;
...
// tom.id = 9527 // Property 'id' does not exist on type 'Person'
...
// let tom51: Person51 = { // Property 'id' is missing in type '{ name: string; gender: string; }' but required in type 'Person51'
//   name: 'Tom',
//   gender: 'male'
// }

// tom.id = 89757 // Property 'id' does not exist on type 'Person'